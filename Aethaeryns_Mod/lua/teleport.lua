...
function starter_teleporters()
   ...
   add_teleporter(267,  25, true,  "Teleporter")
   add_teleporter(210,  55, true,  "Deranion Teleporter")
   add_teleporter(202,  72, false, "Teleporter")
   add_teleporter(147,  86, true,  "Elabril Teleporter")
   add_teleporter(202,  72, false, "Teleporter")
   add_teleporter(141, 122, false, "Teleporter")
   add_teleporter(238,  64, false, "Teleporter")
   add_teleporter(300,  79, false, "Temple Teleporter")
   add_teleporter(310, 144, false, "Teleporter")
   add_teleporter(214, 116, false, "Teleporter")
   add_teleporter(246, 159, false, "Blinadoc Teleporter")
   add_teleporter(214, 171, false, "Teleporter")
end
>>
#enddef

...
local function npc_south_dwarvish_spawns()
   local units = {
      ...
      {342, 195, "Dwarvish Fighter"},
      {348, 195, "Dwarvish Thunderer"},
      ...
      {322, 193, "Dwarvish Fighter"},
      {326, 190, "Dwarvish Scout"},
      {325, 195, "Dwarvish Scout"},
      {330, 192, "Dwarvish Fighter"},
      {332, 191, "Dwarvish Ulfserker"},
      {328, 195, "Dwarvish Ulfserker"},
      {339, 191, "Dwarvish Thunderer"},
      {321, 192, "Dwarvish Guardsman"},
      {322, 190, "Dwarvish Stalwart"},
      {322, 188, "Dwarvish Runesmith"},
      {317, 190, "Dwarvish Runesmith"},
      {320, 187, "Dwarvish Steelclad"},
      {318, 185, "Dwarvish Thunderguard"},
      {316, 186, "Dwarvish Lord"},
      {316, 187, "Dwarvish Arcanister"},
      {315, 188, "Dwarvish Stalwart"},
      {318, 187, "Dwarvish Sentinel"},
      {310, 189, "Dwarvish Pathfinder"},
      {311, 186, "Dwarvish Steelclad"},
      {316, 179, "Dwarvish Guardsman"},
      {311, 179, "Dwarvish Scout"},
      {321, 182, "Dwarvish Berserker"},
   }
   spawn_unit.spawn_region(units, NPC_SIDE)
end
